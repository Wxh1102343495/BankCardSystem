...
<body>
		...
		<div class="row">
			...
			<div class="col-md-7">
				<div class="panel panel-default panel-primary">
					<div class="panel-heading">账户余额查询</div>
					<div class="panel-body">
						<form>
							...
							<button type="button" class="btn btn-success" id="lookyue">查看</button>
						</form>
					</div>
					<table class="table">
						<thead>
	...
	<script type="text/javascript">
		$(function(){
			...
			$("#lookyue").click(function(){
				$("#tb3").empty();
				var lookid=$("#select option:selected").val();
				if(lookid!=""){
					$.getJSON("lookyue.do",{lookid:lookid},function(data){
						console.log(data);
						if(data!=""){
							$.each(data,function(i,s){
								$tr = $("<tr></tr>");
